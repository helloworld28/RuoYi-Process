...
$(document).ready(function () {
    ...
    jQuery.validator.addMethod("isItemNo", function (value, element) {
        var res = false;
        $.ajax({
            type: "GET",
            async: false,
            url: "/process/vendor/getVendorByItemNo/" + value,
    ...
    jQuery.validator.addMethod("isColorCode", function (value, element) {
        var res = false;
        var itemNo = $('#itemNo').val();
        $.ajax({
            type: "GET",
            async: false,
            url: "/process/vendor/getVendorByItemNo/" + itemNo + "/"+ value,
            success: function (response) {
                res = response.code == 0;
            }
        });
